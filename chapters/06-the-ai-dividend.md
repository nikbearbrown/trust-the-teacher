...
The question the Gallup data raises and cannot answer is what happens to the recovered time. Sixty percent of weekly AI-using teachers say they have more time for improving teaching and learning. Sixty percent say they have more time for individualized feedback and support. Fifty-seven percent report better insights into student learning data.
...
In a randomized trial published in *Educational Evaluation and Policy Analysis*, Demszky and colleagues gave treatment-condition instructors in Stanford's large free online CS course a weekly email containing personalized, automated feedback on their uptake score — generated by the NLP tool, delivered to an inbox, requiring no human coach, no released time, no additional training infrastructure. Treatment instructors who engaged with the emails increased their uptake of student contributions by approximately 13 percent relative to control. An email. Read it. Go back to teaching. Thirteen percent.
