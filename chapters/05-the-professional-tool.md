...
The chapter from Lan and Ban and Schimmelpfennig and Fiechter is the same chapter, told four years before AI arrived in classrooms, using yield monitors and a panel of Kansas wheat farms. Nobody writing about EdTech is reading it.
...
The agricultural literature reports the catch-up effect cleanly at the lower end of the farm-efficiency distribution, but the precise share of the 22.3 percent pooled ROI attributable to operator interpretive skill versus to scale, capital, and crop choice is not separated cleanly even in the Fiechter-Schnitkey-Langemeier panel.
